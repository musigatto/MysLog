...
import com.example.myslog.MainActivity
...
class TimerService : Service() {
  ...
  private fun sendStatus() {
    val statusIntent = Intent().also {
      ...
      it.setPackage(packageName) // Make the intent explicit
    ...
    Timber.d("Broadcasting status (explicit): $running, $time, $maxTime to package $packageName")
  }
